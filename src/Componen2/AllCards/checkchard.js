...
function Checkchard() {
  ...
  //     </div>
  // </ReactCardFlip>
  function Card({ title, itemId, item, progressValue }) {
    return (
      <div>
          ...
          <div className="container">
            <div className="">
              <div className="card maincard1">
                    ...
                    <div className="headertext01">
                      <h5 className="textandiconheader">
                        ...
                        <h5
                          ...
                          className={item.headertextclass}
                        >
                          {item.headertext}
                        </h5>
                      </h5>
                ...
                <ProgressBar now={progressValue} className={item.bar} />
                <div className="Uperdivmain mt-3">
                  <div className="uperdiv011">
                    <img
                      src={item.imgSrcuper}
                      className="topimgshapes"
                      alt=""
                    />
                    ...
                    <div className="centercarddiv">
                      <div className={item.display1}>
                        ...
                        <div className="innerdivcentercard">
                          <h4 className="01headingtext">$546.311</h4>
                          <button className={item.btncenter}>
                            {" "}
                            <i class={item.iconarrow}></i> $452
                          </button>
                          {/* <button className="btn btn-success btn-sm"> <i class="far fa-arrow-down"></i> $452</button> */}
                        </div>
                        <div className="innerdivcentercard02">
                          <p className="01headingtext">Locked Price</p>
                          <p>$546.12</p>
                        </div>
                        <div className="innerdivcentercard03">
                          <h5 className="01headingtext">Price Pool:</h5>
                          <h5>27.991 BNB</h5>
                        </div>
                      </div>
                      <div className={item.display2}>
                        <div className="innerdivcentercard">
                          <h6 className="wiinerpool">Winner Pool:</h6>
                          <h6 className="wiinerpool2">1,500 $KNIGHTDOGE</h6>
                        </div>
                        <button
                          className="btn  form-control btn-lg nextbtn1 mt-3"
                          onClick={handleClick}
                        >
                          Stake & UP
                        </button>
                        <button className="btn  form-control btn-lg mt-3 nextbtn2 mb-3">
                          Stake & DOWN
                        </button>
                      </div>
                ...
                <div className="Uperdivmain">
                  <div className="uperdiv011 mb-3">
                    <img
                      src={item.imgSrcdown}
                      className="Bottomimgshapes"
                      alt=""
                      style={{ zIndex: "-1", marginTop: "-3.5rem" }}
                    />
